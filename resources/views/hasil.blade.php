              ...
              <div class="card car-transparent">
                <div class="card-body p-0">
                  <div class="profile-image position-relative">
                    <img src="user/html/assets/images/page-img/profile.png" class="img-fluid rounded w-100" alt="profile-image">
                  </div>
                </div>
              </div>
            </div>
                          ...
                          <div class="card card-block card-stretch mb-0">
                            <div class="card-header px-4">
                              <div class="header-title">
                                <h4 class="card-title">Hasil Pemeriksaan Motor Anda</h4>
                              </div>
                            </div>
                            ...
                            <div class="card-body p-3">
                              <div class="row align-items-center text-center py-2">
                                <div class="profile-info col-xl-3 col-lg-6">
                                  ...
                                  <h5 class="mb-2 mt-3 icon-text-warning"> {{ $k01 }} </h5>
                                  <p class="mb-0">Mesin</p>
                                </div>
                                <div class="profile-info col-xl-3 col-lg-6">
                                  ...
                                  <h5 class="mb-2 mt-3 icon-text-info">{{ $k02 }}</h5>
                                  <p class="mb-0">Kelistrikan</p>
                                </div>
                                <div class="profile-info col-xl-3 col-lg-6">
                                  ...
                                  <h5 class="mb-2 mt-3 icon-text-danger">{{ $k03 }}</h5>
                                  <p class="mb-0">Pengapian</p>
                                </div>
                                <div class="profile-info col-xl-3 col-lg-6">
                                  ...
                                  <h5 class="mb-2 mt-3 icon-text-success">{{ $k04 }}</h5>
                                  <p class="mb-0">Penggerak Roda</p>
                                </div>
                              </div>
                            </div>
